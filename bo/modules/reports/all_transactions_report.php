...
$select = "SELECT id, date, type, ir_id, amount, balance,comments FROM transaction";
...
$columns[] = $new_column;
/// adding new line by kcg , show tranaction from
$new_column = newTextColumn("From/To", "comments");
$columns[] = $new_column;
