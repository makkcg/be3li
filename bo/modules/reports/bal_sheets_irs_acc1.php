...
///get the Managers IRs data
	$managers_irs=array("PA0101","PA0100","PA0102","PA0103");
...
<form method="post" action="bal_sheets_irs_acc.php" name="report">
    <div class="col1_mak">
...
?>
	...
	<div class="sepbold"></div>
		<div class=" printheader">
			<div class="col0">
				<h3 style="text-align: center;">كشف حساب - Balance Sheet</h3>
				<div class="sep"></div>
				<div class="col1_mak border_r">
					<h4>ProShops - Accounting Dep.</h4>
					
					<div class="inforow" style=""><strong>Address: </strong>El Mohandsien, Giza, ARE.</div>
				</div>
				<div class="col2_mak">
					<h4>Account Details</h4>
					<div class="inforow" style=""><strong>IR/Account Code </strong><span class="isir"> <?php if($_POST['ir_id']== "acc01" ){echo "Acc01 - Accountant"}else{ echo $_POST['ir_id']}; ?></span></div>
					
					<div class="inforow" style=""><strong>Date (From) #: </strong><?php if (isset($_POST['from_date']) && $_POST['from_date'] != "") { echo "All"}else{ echo $_POST['from_date']}; ?></div>
					<div class="inforow" style=""><strong>Date (To) #: </strong><?php if (isset($_POST['to_date']) && $_POST['to_date'] != "") { echo "All"}else{ echo $_POST['to_date']}; ?></div>
					<div class="inforow" style=""><strong>Full Name: </strong><?php echo "NAME"; ?></div>
				</div>
			</div>
		</div>
		<div class='sep'></div>
		<div class="col0">
		<h4 style="text-align: center;">Balance Sheet Details</h4>
		</div>
