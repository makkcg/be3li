...
if(isset($_POST) && isset($_POST['ir_id']) && isset($_POST['payment_val']) && isset($_POST['payment_method']) && $_POST['secret'] == "4unf9unufru49fnr9" && $_POST['payment_val']!="" && $_POST['ir_id']!="" && $_POST['payment_method']!=""){
		...
		if($payment_method=="cash" || $payment_method=="bank"){
			...
			if($diff_ir_ec>=0){
				...
				$comment .= "<br><strong> Notes: ".$paymentNotes."<\/strong";
 ...
 <?php
	...
	<div class="col2">
        <label >Additional Notes :
            <span class="mandatory">*</span></label>
			<textarea name="payment_notes" id="payment_notes" form="myform" style="width: 100%;"> </textarea>
        <!--<input type="textarea" name="payment_notes" value="" style="width: 100%;">-->
		<div id="currency" style="display: inline-block;margin:0 5px;"></div>
        </br></br>
        <div class="sep"></div>
        </br>
	</div>
