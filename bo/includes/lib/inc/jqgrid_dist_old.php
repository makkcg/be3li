...
class jqgrid {
    ...
    function render_js($grid_id, $out) {
        ...
        <?php if (isset($this->actions["export_csv"]) && $this->actions["export_csv"] === true) { ?>
            // Export to csv
            jQuery("#<?php echo $grid_id ?>").jqGrid('navButtonAdd',"#<?php echo $grid_id . "_pager" ?>",{caption:"<?php echo $_SESSION['main_language']->csv; ?>",title:"<?php echo $_SESSION['main_language']->csv; ?>", buttonicon :'ui-icon-extlink',
            onClickButton:function(){
