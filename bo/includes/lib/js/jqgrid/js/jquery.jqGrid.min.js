                        ...
                        if (this.search) {
                            ...
                            switch (this.stype) {
                                ...
                                case "text":
                                    ...
                                    a("td:eq(1)", n).append("<input type='text' style='width:100%;padding:0px;' name='" + (f.index || f.name) + "' id='gs_" + f.name + "' autocomplete='off' value='" + w + "'/>");
                                    a(l).append(n);
            ...
            if (!this.filter) {
                ...
                if (q) {
                    ...
                    this.createTableRowForRule = function (g, l) {
                        ...
                        d = a("<td></td>");
                        m.append(d);
                        !0 === this.p.ruleButtons && (p = a("<input type='button' value='x' title='Delete rule' class='delete-rule ui-del'/>"), d.append(p), p.bind("click", function () {
