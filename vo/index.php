...
if (date("H") == 23 && $_GET['error'] != "freeze"  && false) {
	...
	}elseif (isset($_GET) && isset($_GET['refir']) && $_GET['refir'] != ""){				include "user/register_second_step" . "". ".php";	
    ...
    } elseif ((!isset($_SESSION['secret']) || $_SESSION['secret'] != "e0d39uN3hb38f4uhR84rhf84rfe9e9dfedfc33" ) || ( isset($_SESSION['last_activity']) && (time() - $_SESSION['last_activity'] > ( 60 * 60 ) ) ) || isset($_GET) && $_GET['page'] == "login") {
