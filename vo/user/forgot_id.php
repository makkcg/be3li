...
<div class="login_box">
    ...
    <p>Kindly, enter you email address to retrieve you IR ID.</p>
    <p id="error" class="center">
        <?php
        if ($_POST){
            if ($ir_id = $core->getIdFromEmail($database_manager, $_POST['email'])){
                $msg = "You IR ID is: " . $ir_id;
                if($core->email($database_manager, $_POST['email'], "Forgot my IR ID", $msg)){
                    echo "An email was sent to you containing your IR ID.";
                }else{
