...
if($_SESSION['isactivated'] && isset($_SESSION['isactivated'])){
...
<?php
$html_page->writeBody("Verify My Account",$core->getewalletval($database_manager,$_SESSION['ir_id']));
?>
    ...
    function validateForm()
    {
		...
		var y = document.forms["myform"]["ewallet_pass"].value;
                ...
                if (y.split('').length < 8) {
                    ...
                    document.getElementById("error").innerHTML = "Passwords must be at least 8 characters. E-Wallet Password";
                ...
                if (z == '') {
                    ...
                    document.getElementById("error").innerHTML = "<?php echo $_SESSION["language"]->fundtransfer_msg_mandatoryfieldsblank;?> Confirm E-Wallet Password";
    ...
    if ($_POST) {
        ...
        if ( isset($_SESSION['ir_id']) && $_SESSION['ir_id']!="") {
            ...
            $sql = "UPDATE ir "
					...
					. " , ewallet_pass = '" . $ewallet_pass_crypt . "' "
					. " , isactivated = 1 "
            ...
            if ($database_manager->query($sql)) {
				...
				$_SESSION['isactivated']=0;
            }
        } else {
            echo "The irid: ".$_SESSION['ir_id']." session not ok";
        }
    }
...
<form method="post" name="myform" onsubmit="return validateForm();" class="col-xs-12 col-md-12 col-lg-12 col-xl-12 myaccountform">
    ...
    <input name="email" type="text" value="<?php echo $row['email'] ?>" class="col-xs-12 col-md-9 col-lg-9 col-xl-9" />  <br class="clear"/>
