...
if (isset($_GET['id']) && $_GET['id'] == "reset") {
    ...
    $sql = "INSERT INTO shop_order_line (shop_order_id, product_name, price, rpts, dcpts, is_vacation) VALUES ("
            . " '" . $_SESSION['order_id'] . "', '" . $row['name'] . "', '" . $row['total_price'] . "', '" . $row['rpts'] . "', '" . $row['dcpts'] . "', '" . $row['is_vacation'] . "' "
            . ")";
    $database_manager->query($sql);
}
...
if (isset($_GET['id']) && $_GET['id'] == "confirm" && isset($_POST) && $_SESSION['order_id'] != "" && $has_enough_funds) {
    ...
    if ($_GET['title'] == "My Shop") {
        ...
        $sql = "INSERT INTO transaction (ir_id, type, date, amount, balance, comments) ";
        $sql .= " VALUES ('" . $_SESSION['ir_id'] . "', 'Direct Binary Commission', '";
...
//////////OO
    ...
    if (isset($_SESSION['order_id']) && $_SESSION['order_id'] != "") {
        ...
        <form method="post" name="myform" action="index.php?page=cart&title=<?php echo $_GET['title']; ?>&id=confirm"
